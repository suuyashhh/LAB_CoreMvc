namespace Lab_Mvc.Constants
{
    public class QueryConstant
    {
        ...
        public static string GetDoctors = "Doctors";
        ...
        public static string GetCasePapers = "CasePapers";
        public static string GetCasePaperById = "GetCasePaperById";
        public static string GetDateWiseCasePaper = "GetDateWiseCasePaper";
        ...
        public static string GetEmployees = "Employees";
        ...
        public static string GetLabMaterials = "LabMaterials";
        public static string GetMaterialById = "GetMaterialById";
        public static string GetDateWiseLabMaterials = "GetDateWiseLabMaterials";
        ...
        public static string GetBikeFule = "BikeFule";
        public static string GetBikeFuleById = "GetBikeFuleById";
        public static string GetDateWiseBikeFule = "GetDateWiseBikeFule";
        ...
        public static string GetEmployeeSalary = "EmployeeSalary";
        public static string GetEmployeeSalaryById = "GetEmployeeSalaryById";
        public static string GetDateWiseEmpSalary = "GetDateWiseEmpSalary";
        ...
        public static string GetElectricityBill = "ElectricityBill";
        public static string GetElectricityBillById = "GetElectricityBillById";
        public static string GetDateWiseElcBill = "GetDateWiseElcBill";
        ...
        public static string GetOtherExpense = "OtherExpense";
        public static string GetOtherExpenseById = "GetOtherExpenseById";
        public static string GetDateWiseOthMaterials = "GetDateWiseOthMaterials";
        ...
        public static string GetDoctorCommission = "DoctorCommission";
        public static string GetDoctorCommissionById = "GetDoctorCommissionById";
        public static string GetDateWiseDocCommission = "GetDateWiseDocCommission";
