...
namespace Lab_Mvc.Interfaces.Tejas
{
    ...
    {
        Task<IEnumerable<DTOTejasEntry>> GetAll(long userId, bool isPaid);
        Task<IEnumerable<DTOTejasEntry>> GetAllTypesEntrys(long userId, System.DateTime? fromDate = null, System.DateTime? toDate = null);
